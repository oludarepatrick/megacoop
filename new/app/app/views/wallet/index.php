                    ...
                    <tbody>
                        <?php foreach ($wallet as $st) { ?>
                            <tr>
                                ...
                                <td>
                                    <a data-fancy href="<?= base_url('wallet/preview/' . $this->utility->mask($st->id)) ?>" data-toggle="tooltip" title="<?= lang('preview') ?>" class="btn btn-info btn-sm"><i class="mdi mdi-dots-vertical"></i> </a>
                                    <a data-fancy href="<?= base_url('wallet/verify/' . $this->utility->mask($st->id)) ?>" data-toggle="tooltip" title="<?= lang('verify') .' '. lang('tranx') ?>" class="btn btn-success btn-sm"><i class=" mdi mdi-check"></i> </a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
