    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4><?= lang('request_loan') ?></h4>
            </div>

            <div class="card-body">
                <?= form_open('member/loan/request', 'class="needs-validation" novalidate') ?>
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="amount" id="amount" class="form-control" required onblur="get_loan_info()" value="<?= set_value('amount') ?>" data-toggle="input-mask" data-mask-format="#,##0" data-reverse="true">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        <button type="submit" class="btn btn-primary btn-block float-right mt-4"><i class="mdi mdi-floppy mr-1"></i><?= lang('request_loan') ?></button>
                    </div>
                </div>
                <?= form_close() ?>
            </div>
