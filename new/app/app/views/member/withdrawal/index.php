                    ...
                    <div class="col-sm-6 col-xl-6">
                        <div class="card shadow-none m-0">
                            <div class="card-body text-center">
                                ...
                                <h3><span class="text-success"><?= number_format($total_withdrawal->amount, 2) ?></span></h3>
                    ...
                    <div class="col-sm-6 col-xl-6">
                        <div class="card shadow-none m-0 border-left">
                            <div class="card-body text-center">
                                ...
                                <h3><span class="text-primary"><?= number_format($filter_total_withdrawal->amount, 2) ?></span></h3>
            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-12">
                        ...
                        <a data-fancy href="<?= base_url('member/withdrawal/request') ?>" class="btn btn-primary m-1 float-right" data-toggle="tooltip" title="Request Withdrawal"><i class="mdi mdi-plus"></i> </a>
                    </div>
                </div>
                ...
                <table class="table table-bordered dt-responsive nowrap w-100" id="basic-datatable-member">
                    <thead>
                        <tr>
                            <th>
                                <span><i class="mdi mdi-calendar-range"> </i></span><?= lang('withdrawals') ?></span>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($withdrawals as $st) { ?>
                            <tr>
                                <td>
                                    <a data-fancy href="<?= base_url('member/withdrawal/preview/' . $this->utility->mask($st->id)) ?>" class="text-secondary">
                                        <div>
                                            <span class="font-weight-bolder"> <?= ucfirst($st->savings_type) ?></span>
                                            <?php if ($st->status == 'due') { ?>
                                                <span class="badge badge-primary float-right"><?= lang('processing') ?></span>
                                            <?php } ?>
                                            <?php if ($st->status == 'paid') { ?>
                                                <span class="badge badge-success float-right"><?= lang('successful') ?></span>
                                            <?php } ?>
    ...
    <div class="modal-dialog modal-sm modal-right">
        <div class="modal-content ">
            ...
            <div class="modal-body">
                ...
                <div class="">
                    <?= form_open('member/withdrawal', 'class="needs-validation" novalidate') ?>
                    <div class="row">
                        <div class=" col-md-12">
