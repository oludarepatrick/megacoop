            ...
            <div class="h-100" id="left-side-menu-container" data-simplebar>
                ...
                <ul class="metismenu side-nav">
                    ...
                    <li class="side-nav-item">
                        <a data-fancy href="<?= base_url('member/dashboard') ?>" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a data-fancy href="<?= base_url('member/wallet') ?>" class="side-nav-link">
                            <i class="uil-wallet"></i>
                            <span> <?= lang('wallet_trans') ?></span>
                        </a>
                    </li>
                    <li class="side-nav-item">
                        <a data-fancy href="<?= base_url('member/savings') ?>" class="side-nav-link">
                            <i class=" uil-briefcase"></i>
                            <span> <?= lang('savings') ?></span>
                        </a>
                    </li>
                    <li class="side-nav-item">
                        <a data-fancy href="<?= base_url('member/loan') ?>" class="side-nav-link">
                            <i class=" uil-moneybag"></i>
                            <span> <?= lang('loan') ?></span>
                        </a>
                    </li>
                    <li class="side-nav-item">
                        <a data-fancy href="<?= base_url('member/creditsales') ?>" class="side-nav-link">
                            <i class=" uil-gift"></i>
                            <span> <?= lang('credit_sales') ?></span>
                        </a>
                    </li>
                    <li class="side-nav-item">
                        <a data-fancy href="<?= base_url('member/withdrawal') ?>" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        ...
                        <ul class="side-nav-second-level" aria-expanded="false">
                            <li>
                                <a data-fancy href="<?= base_url('member/miscellaneous') ?>"><?= lang('bye_law') ?></a>
                            </li>
                            <li>
                                <a data-fancy href="<?= base_url('member/miscellaneous/minutes') ?>"><?= lang('minutes') ?></a>
                            </li>
                            <li>
                                <a data-fancy href="<?= base_url('member/miscellaneous/training') ?>"><?= lang('training') ?></a>
                            </li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <ul class="list-unstyled topbar-right-menu float-right mb-0">
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle arrow-none" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <?php if ($this->member_notification) { ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg">
                                ...
                                <div style="max-height: 230px;" data-simplebar>
                                    <?php foreach ($this->member_notification as $note) { ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg p-0">
                                ...
                                <div class="p-2">
                                    <div class="row no-gutters">
                                        <div class="col">
                                            <a class="dropdown-icon-item" data-fancy href="<?= base_url('member/guarantor') ?>">
                                                <i class="uil uil-user font-20"> </i>
                                                <span><?= lang('gurantor_request') ?></span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" data-fancy href="<?= base_url('member/statement') ?>">
                        ...
                        <li class="dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                                <!-- item-->
                                <div class=" dropdown-header noti-title text-center bg-light">
                                    <img src="<?= $assets ?>images/users/<?= $this->user->avatar ?>" alt="image" class="img-fluid avatar-sm img-thumbnail">
                                </div>
                                <div class=" p-0 dropdown-header noti-title text-center bg-light">
                                    <span>Welcome!</span>
                                </div>

                                <!-- item-->
                                <a data-fancy href="<?= base_url('member/profile') ?>" class="dropdown-item notify-item bg-light">
                                    <i class="mdi mdi-account-heart mr-1"></i>
                                    <span><?= ucwords($this->user->first_name . ' ' . $this->user->last_name) ?></span>
                                </a>
                                <a data-fancy href="<?= base_url('member/profile') ?>" class="dropdown-item notify-item">
                                    <i class="mdi mdi-account-circle mr-1"></i>
                                    <span><?= lang('profile') ?></span>
                                </a>

                                <!-- item-->
                                <a data-fancy href="<?= base_url('member/profile/security') ?>" class="dropdown-item notify-item">
                                    <i class="mdi mdi-shield-lock-outline mr-1"></i>
                                    <span><?= lang('security') ?></span>
                                </a>
                                <a data-fancy href="<?= base_url('member/profile/preferences') ?>" class="dropdown-item notify-item">
