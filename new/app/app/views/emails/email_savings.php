        ...
        <div style="text-align: center;padding: 10px;">
            <div style="display: inline-block; border-radius: 3px; width: 400px; height:100%;  background: white">
                ...
                <div style=" padding: 8% 0% 8% 0%; background: #0364B8;">
                    <p style="color:white ; padding: 0% 10% 0% 10%; font-size: 14px;">Amount Paid</p>
                    <h1 style="color:white; margin: 1% 0% 0% 0%; font-size: 40px;"><?= $amount?></h1>
                </div>
                <div style="padding: 3%"> 
                    <div style="text-align: left; ">
                        <p style="font-size:14px">Hello <?= ucwords($name) ?> <br> MemberID: <?= $member_id ?></p>
                        <p style="margin: 0% 0% 4% 0%;">This is a contribution notification on your cooperative account</p> 
                    </div>
                    ...
                    <div style=" margin: 1% 0% 0% 0%; padding:3% 0% 3% 0%; border-left: solid 5px #0364B8; text-align: left; padding: 1% 2% 1% 4%; background:white;"> 
                        <strong style="width:46%; display: inline-block;">Month:</strong> <span style=" width: 46%; display: inline-block;"><?= $month ?></span>
                    </div>
                    <div style="margin: 1% 0% 0% 0%; padding:3% 0% 3% 0%; border-left: solid 5px #0364B8; text-align: left; padding: 1% 2% 1% 4%; background:white;"> 
                        <strong style="width:46%; display: inline-block;">Year:</strong> <span style=" width: 46%; display: inline-block;"><?= $year ?></span>
                    </div>
                    <div style="margin: 1% 0% 0% 0%; padding:3% 0% 3% 0%; border-left: solid 5px #0364B8; text-align: left; padding: 1% 2% 1% 4%; background:white;"> 
                ...
                <div style=" padding: 8% 0% 8% 0%; background: #0364B8;">
                    <p style="color:white ; padding: 0% 10% 0% 10%; font-size: 14px;">Contribution Balance</p>
                    <h1 style="color:white; margin: 1% 0% 0% 0%; font-size: 40px;"><?= $balance ?></h1>
                </div>
