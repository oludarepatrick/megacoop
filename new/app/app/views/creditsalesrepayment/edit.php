...
<div class="row justify-content-center">
    <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                <?= form_open('creditsalesrepayment/edit/' . $this->utility->mask($credit_sales_repayment->id), 'class="needs-validation" novalidate') ?>
                <div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="amount" id="amount" class="form-control" required value="<?= set_value('amount', $credit_sales_repayment->amount) ?>" data-toggle="input-mask" data-mask-format="000.000.000.000,000,000.00" data-reverse="true">
                    </div>
                    <div class="col-md-6 form-group">
                        ...
                        ?>
                        <?= form_dropdown('source', $scc, set_value('source', $credit_sales_repayment->source), 'class="form-control select2" name="source"  id="source" data-toggle="select2"'); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="<?= lang('month') ?>"><?= lang('month') ?></label>
                        <input type="text" name="month" class="form-control" value="<?= set_value('month', $credit_sales_repayment->month) ?>" data-provide="datepicker" data-date-format="MM" data-date-min-view-mode="1">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="<?= lang('year') ?>"><?= lang('year') ?></label>
                        <input type="text" name="year" class="form-control" value="<?= set_value('year', $credit_sales_repayment->year) ?>" data-provide="datepicker" data-date-format="yyyy" data-date-min-view-mode="2">
                    </div>
                </div>
                <div class="form-group">
                    <label for="<?= lang('narration') ?>"><?= lang('narration') ?></label>
                    <textarea class="form-control" name="narration" required=""><?= $credit_sales_repayment->narration ?></textarea>
                </div>
