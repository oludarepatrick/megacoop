    ...
    <div class="col-xl-8">
        <div class="card">
                ...
                <div class="form-row">
                    ...
                    <div class=" col-md-4 form-group">
                        <a id="hide_generate_savin_btn" data-toggle="tooltip" data-placement="bottom" title="Download"
                           class="btn btn-primary text-white mb-2" onclick="generate_credit_sales_repayment_template()">
                    ...
                    <div class="p-1">
                        <div class="row align-items-center">
                            ...
                            <div class="col pl-0 d-none d-sm-block">
                                <a class="text-muted font-weight-bold">credit-sales-repayment-template.xls</a>
            ...
            <div class="card-body">
                ...
                <?= form_open_multipart('creditsalesrepayment/add_batch', 'class="needs-validation" novalidate') ?>
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <?php
                        $stt[""] = lang('select') . ' ' . lang('product_types');
                        foreach ($product_types as $st) {
                            $stt[$st->id] = $st->name;
                        }
                        ?>
                        <?= form_dropdown('product_type', $stt, set_value('product_type'), 'class="form-control select2" name="product_type"  id="product_type" data-toggle="select2"'); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 form-group">
