...
<div class="container-fluid">
        ...
        <div class="col-xl-8">
            <div class="card">
                <div class="row">
                    ...
                    <div class="col-8">
                        <div class="mt-4 float-right mr-2">
                            <?php if ($user->active == 1 and $user->status == 'approved') { ?>
                                <input type="checkbox" id="switch1" onclick="member_approval('true', <?= $user->id ?>)" checked data-switch="bool" />
                            <?php } else { ?>
                                <input type="checkbox" id="switch1" onclick="member_approval('false', <?= $user->id ?>)" data-switch="bool" />
                            <?php } ?>
                            <label for="switch1" data-on-label="Yes" data-off-label="No"></label>
                        </div>
                        <div class="mt-4 float-right mr-2">
                            <p class="font-weight-bolder">Approved</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="tab-pane active show" id="basictab1">
                            <div class="card-body">
                                <span class="float-left m-2 mr-5">
                                    <img src="<?= $assets ?>images/users/<?= $user->avatar ?>" style="height: 100px;" class="rounded img-thumbnail">
                                </span>
                                <div class="media-body">
                                    ...
                                    <ul class="mb-0 list-inline">
                                        <li class="list-inline-item mr-3">
                                            ...
                                            <?php } else {  ?>
                                                <h5 class="mb-1">Not Available</h5>
                                            <?php }  ?>
                                            <p class="mb-0 font-13"><?= lang('last_login') ?></p>
                                        </li>
                                        <li class="list-inline-item">
                                            <h5 class="mb-1"><?= $this->utility->just_date($user->reg_date, false) ?></h5>
                                ...
                                <div class="form-group position-relative mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-md-6 mt-3">
                                            ...
                                            <?= form_dropdown('user_group', $user_group, set_value('user_group', $user->group_id), 'class="form-control select2" onchange="change_user_group()"  id="user_group" data-toggle="select2"'); ?>
                                        </div>

                                        <div class=" col-md-6 mt-3" id="role_id_box" <?php if ($user->group_id == 2) echo 'style="display:none"'; ?>>
                                            ...
                                            ?>
                                            <?= form_dropdown('role_id', $ro, set_value('role_id', $user->role_id), 'class="form-control select2"   id="role_id" data-toggle="select2"'); ?>
                                        </div>
                                        <div class=" col-md-6 mt-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-md-4 mt-3">
                                            ...
                                            <input type="text" name="reg_fee" class="form-control" id="reg_fee" value="<?= set_value('reg_fee', $user->reg_fee) ?>">
                                        </div>
                                ...
                                <a class="btn btn-danger float-left text-white" data-target="#rest_password" data-toggle="modal"> <i class="mr-1"></i> <?= lang('reset_pass') ?></a>
                                        ...
                                        <tbody>
                                            <?php foreach ($existing_loans as $el) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <?= number_format($el->monthly_due, 2) ?></td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= form_open('registration/update_email/' . $this->utility->mask($user->id), 'class="needs-validation" novalidate') ?>
    ...
    <div class="modal fade" id="edit_phone" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= form_open('registration/update_phone/' . $this->utility->mask($user->id), 'class="needs-validation" novalidate') ?>
                    <div class="form-group">
                        <label for="<?= lang('phone') ?>"><?= lang('phone') ?></label>
    ...
    <div class="modal fade" id="rest_password" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myCenterModalLabel"><?= lang('reset_pass')?></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <?= form_open('registration/reset_password/' . $this->utility->mask($user->id), 'class="needs-validation" novalidate') ?>
                    <div class="form-group">
                        <label for="<?= lang('password') ?>"><?= lang('password') ?></label>
                        <input type="text" name="password" class="form-control" id="password" value="<?= set_value('password', '12345678') ?>" required>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary float-right my-2"><?= lang('reset_pass') ?></button>
                    </div>
                    <?= form_close() ?>
                </div>
            </div>
