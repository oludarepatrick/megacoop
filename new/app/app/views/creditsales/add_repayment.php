            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="amount" id="amount" class="form-control" required value="<?= set_value('amount') ?>" data-toggle="input-mask" data-mask-format="000.000.000.000,000,000" data-reverse="true">
                    </div>
                    <div class="col-md-6 form-group">
                        ...
                        ?>
                        <?= form_dropdown('loan_type', $scc, set_value('loan_type'), 'class="form-control select2" required onchange="generate_loan_guarantor_field()" name="loan_type"  id="loan_type" data-toggle="select2"'); ?>
                    </div>
                </div>
