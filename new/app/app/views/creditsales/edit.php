...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <?= form_open('creditsales/edit/' . $this->utility->mask($product_type->id), 'class="needs-validation" novalidate') ?>
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="amount" id="amount" class="form-control" required value="<?= set_value('amount', $product_type->principal) ?>" data-toggle="input-mask" data-mask-format="#,##0.00" data-reverse="true">
                    </div>
                    <div class="col-md-6 form-group">
                        ...
                        ?>
                        <?= form_dropdown('product_type', $scc, set_value('product_type', $product_type->product_type_id), 'class="form-control select2" required onchange="generate_credit_sales_guarantor_field()" name="product_type"  id="product_type" data-toggle="select2"'); ?>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" name="tenure" class="form-control" id="tenure" value="<?= set_value('tenure', $product_type->tenure) ?>" required data-toggle="touchspin" type="text" data-step="1" data-decimals="0">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" value="<?= set_value('description') ?>" id="description" name="description" required=""><?= $product_type->description ?></textarea>
                </div>
