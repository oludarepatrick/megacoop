    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?= form_open('withdrawal/add', 'class="needs-validation" novalidate') ?>
                <div class="row">
                ...
                <div class="float-left">
                    <p>Ignore withdrawl limit</p>
                    <input name="ignore_limit" type="checkbox" id="switch1" data-switch="bool" />
                    <label for="switch1" data-on-label="Yes" data-off-label="No"></label>
                </div>
                <button type="submit" class="btn btn-primary float-right mt-3"><i class="mdi mdi-floppy mr-1"></i><?= lang('save') ?></button>
                <?= form_close() ?>
            </div>
        </div>
    </div>
