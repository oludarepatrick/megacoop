    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="row">
                    <div class="col-4">
                        <h4 class="header-title mt-4 ml-2"><?= lang('withdrawal_request') ?></h4>
                    </div>
                </div>
                <div id="basicwizard">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive table-bordered">
                                    <table class="table mb-0 dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
                                                <th><?= lang('withdrawal') . ' ' . lang('amount') ?></th>
                                                <th class="text-danger"><?= number_format($withdrawal->amount, 2) ?></th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
                        ...
                        <div class="tab-pane" id="basictab2">
                            <div class="card-body">
                                ...
                                <div class="text-center mt-2">
                                    <a data-fancy href="<?= base_url('withdrawal/approve/' . $this->utility->mask($savings_id)) ?>" class="btn btn-primary"><i class=" mdi mdi-check-bold mr-1"></i> <?= lang('approve') ?> </a>
                                </div>
                            </div>
                        </div>
                    </div>
