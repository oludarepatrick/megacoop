                    ...
                    <tbody>
                        <?php foreach ($withdrawals as $st) { ?>
                            <tr>
                                ...
                                <td><span class="badge-primary badge"> pending</span></td>
                                <td>
                                    <a data-fancy href="<?= base_url('withdrawal/preview_request/' . $this->utility->mask($st->id)) ?>" data-toggle="tooltip" title="<?= lang('approve') ?>"  class="btn btn-success btn-sm"><i class="mdi mdi-check-all"></i> </a>
                                    <a data-fancy href="<?= base_url('withdrawal/decline/' . $this->utility->mask($st->id)) ?>" onclick="return confirm('Are you sure you want to decline this?')" data-toggle="tooltip" title="<?= lang('decline') ?>"  class="btn btn-danger btn-sm"><i class="mdi mdi-delete"></i> </a>
                                </td>
                            </tr>
                        <?php } ?>
