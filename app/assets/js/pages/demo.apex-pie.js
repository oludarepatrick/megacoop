...
colors = ["#727cf5", "#6c757d", "#fa5c7c",  "#323A46"];
(dataColors = $("#gradient-donut").data("colors")) &&
        (colors = dataColors.split(","));
options = {
    chart: {height: 360, type: "donut"},
    series: [od.savings_bal, od.wallet_bal, od.loan_bal, od.credit_sales_bal],
    legend: {
        show: !0,
        position: "bottom",
        horizontalAlign: "center",
    ...
    labels: ["Savings Balance", "Wallet Balance", "Loan Balance", "Credit Sales Balance"],
    colors: colors,
    responsive: [
        {
            breakpoint: 600,
