    ...
    <div class="col-lg-7">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?= form_open('agency/savings/add', 'class="needs-validation" novalidate') ?>
                <div class="row">
                    <div class=" col-md-6 form-group">
                        <label for="<?= lang('member_id') ?>"><?= lang('member_id') ?></label>
                        <input type="text" name="member_id" value="<?= set_value('member_id') ?>"  id="member_id" class="form-control" required>
                    </div>
                    <div class="col-md-6 form-group">
