    ...
    <div class="col-md-6">
        <div class="card ">
            ...
            <div class="card-body">
                ...
                <?= form_open('agency/wallet/load_wallet', 'class="needs-validation" novalidate') ?>
                <div class="form-group mb">
                    <label for="<?= lang('amount') ?>"><?= lang('amount') ?></label>
                    <input type="text" name="amount" class="form-control" id="amount" maxlength="15" srequired value="<?= set_value('amount') ?>" data-toggle="input-mask" data-mask-format="#,##0" data-reverse="true">
                </div>
