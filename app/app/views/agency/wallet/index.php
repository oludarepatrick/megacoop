            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-12">
                        ...
                        <a data-fancy href="<?= base_url('agency/wallet/load_wallet') ?>" class="btn btn-primary float-right m-1"><i class="mdi mdi-plus"></i></a>
                    </div>
                </div>
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <div class="border border-light rounded bg-primary p-2 mb-3 text-white">
                    ...
                    <p><?= lang('filter_note') ?> </p>
                </div>
                <div class="">
                    <?= form_open('agents/wallet', 'class="needs-validation" novalidate') ?>
                    <div class="row">
                        <div class=" col-md-12">
