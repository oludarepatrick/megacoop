...
<div class="row justify-content-center">
    <div class="col-xl-8">
        <div class="card">
            ...
            <div class="card-body">
                <?= form_open('agency/loan/edit/' . $this->utility->mask($loan->id), 'class="needs-validation" novalidate') ?>
                <div class="row">
                    <div class=" col-md-12 form-group">
                        ...
                        <input type="text" value="<?=$loan->username?>" name="member_id" required oninput="member_info_live_search()" onmouseover="get_loan_info()" id="member_id" class="form-control">
                        <div id="result"></div>
                    </div>
                </div>
