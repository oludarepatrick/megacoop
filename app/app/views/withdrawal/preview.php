                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 offset-sm-2">
                        <div class="mt-3 float-sm-right">
                            ...
                            <p class="font-13"><strong><?= lang('payment_status') ?>: </strong> 
                                <?php if($withdrawal->status =='due'){ ?>
                                    <span class="badge badge-warning float-right"><?= lang('processing') ?></span>
                                <?php } ?>
                                <?php if($withdrawal->status =='paid'){ ?>
                                    <span class="badge badge-warning float-right"><?= $withdrawal->status ?></span>
                                <?php } ?>
                            </p>
