                    ...
                    <div class="col-sm-6 col-xl-6">
                        <div class="card shadow-none m-0">
                            <div class="card-body text-center">
                                ...
                                <h3><span class="text-success"><?= number_format($total_credit_sales->principal, 2) ?></span></h3>
                                <p class="text-success font-15 mb-0"><?= lang('total').' '. lang('credit_sales') ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-6">
                        <div class="card shadow-none m-0 border-left">
                            <div class="card-body text-center">
                                ...
                                <h3><span class="text-primary"><?= number_format($filter_total_credit_sales->principal, 2) ?></span></h3>
                ...
                <table  class="table table-striped table-bordered dt-responsive nowrap w-100" id="datatable-buttons">
                    ...
                    <tbody>
                        <?php foreach ($credit_sales as $st) { ?>
                            <tr>
                                <td><?= $this->utility->just_date($st->created_on, false) ?></td>
                                <td><?= $st->username ?></td>
                                ...
                                <td>
                                    <a data-fancy href="<?= base_url('creditsales/supply/'.$this->utility->mask($st->id))?>" onclick="return confirm('Are you sure the product is supplied')" data-toggle="tooltip" title="<?= lang('supply') ?>"  class="btn btn-primary btn-sm"><i class="mdi mdi-cart-plus"></i> </a>
                                </td>
                            </tr>
                        <?php } ?>
    ...
    <div class="modal-dialog modal-sm modal-right">
        <div class="modal-content ">
            ...
            <div class="modal-body">
                ...
                <div class="">
                    <?= form_open('creditsales/approved', 'class="needs-validation" novalidate') ?>
                    <div class="row">
                        <div class=" col-md-12">
