    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <h4 class="header-title mt-4 ml-2"><?= lang('credit_sales_request') ?></h4>
                    ...
                    <div class="tab-content b-0 mb-0">
                        <div class="tab-pane active show" id="basictab1">
                            <div class="collapse show" id="todayTasks">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive table-bordered mt-4">
                                        <h5 class="ml-2 text-danger"><?= lang('existing_credit_sales') ?></h5>
                                        <table class="table mb-0">
                                            <thead class="thead-light">
                                                <tr>
                        ...
                        <div class="tab-pane" id="basictab3">
                            ...
                            <div class="card-footer text-right">
                                <a data-fancy href="<?= base_url('creditsales/decline/' . $this->utility->mask($loan->id)) ?>" onclick="return confirm('Are you sure you want to decline')" class="btn btn-danger"><i class="mdi mdi-delete mr-2"></i><?= lang('decline') ?></a>
                                <a data-fancy href="<?= base_url('creditsales/approve/' . $this->utility->mask($loan->id)) ?>" onclick="return confirm('Are you sure you want to approve')" class="btn btn-primary"><i class="mdi mdi-checkbox-marked-circle-outline mr-2"></i><?= lang('approve') ?></a>
                            </div>
                        </div>
                    </div> <!-- tab-content -->
                </div> <!-- end card-body -->
