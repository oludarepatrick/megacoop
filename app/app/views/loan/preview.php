    ...
    <div class="row justify-content-center">
        <div class="col-xl-8">
            <div class="card">
                ...
                <h4 class="header-title mt-4 ml-2"><?= lang('loan_request') ?></h4>
                    ...
                    <div class="tab-content b-0 mb-0">
                        ...
                        <div class="tab-pane" id="basictab3">
                            ...
                            <div class="card-footer text-right">
                                ...
                                <a data-fancy href="<?= base_url('loan/approve/' . $this->utility->mask($loan->id)) ?>" onclick="return confirm('Are you sure you want to approve')" class="btn btn-primary"><i class="mdi mdi-checkbox-marked-circle-outline mr-2"></i><?= lang('approve') ?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= form_open("loan/decline/" . $this->utility->mask($loan->id), 'class="needs-validation" novalidate') ?>
                    <div class="form-group">
                        <label for="<?= lang('note') ?>">Let <strong><?= ucwords($loan->full_name) ?></strong> why his/her request was declined </label>
