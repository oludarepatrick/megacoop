        ...
        <div class="align-items-center d-flex h-100">
            <div class="card-body pt-5">
                <div class="text-center w-100 mt-5 ">
                    <img src="<?= $assets ?>images/logo/<?= $app_settings->logo ?>" height="50" alt="">
                    <h4 class="mt-2"><?= lang('login') ?></h4>
                ...
                <div id="auth_root">
                    ...
                    <div class="form-group ">
                        <label for="password">IDENTITY</label>
                        <p>Login to your cooperative account</p>
                        <div id="err" class="text-danger"></div>
                        <div class="input-group input-group-merge">
                            <input name="identity" class="form-control form-control-lg" type="text" id="identity" required="" placeholder="<?= lang('email_memberid') ?>">
                    ...
                    <div class="form-group ">
                        <div class="custom-control custom-checkbox">
                            ...
                            <a href="<?= base_url('auth/init_forgot_password') ?>" class="text-muted float-right"><small>Forgot your password?</small></a>
                        </div>
                    </div>
                    <div class="form-group mb-0 mt-3 text-center">
                        <button class="btn btn-primary btn-block btn-lg" type="button" id="login" onclick="auth_start()"><i class="mdi mdi-account-search-outline"></i> Fetch </button>
                        <button id="auth" style="display: none" class="btn btn-primary btn-lg btn-block" type="button" disabled>
                            <span class="spinner-border spinner-border-sm mr-1" role="status" aria-hidden="true"></span>
                            <span class="">Fetching account...</span>
                        </button>
                    </div>
                    <?= form_close() ?>
                </div>
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">Don't have an account?
                        ...
                        <!-- <a href="<?=base_url('register/vastworth')?>"><b><?= lang('register') ?></b></a> -->
                    </p>
                </footer>
