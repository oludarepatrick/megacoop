    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-12">
                        <a data-fancy href="<?= base_url('registration/add_member') ?>" class="btn btn-primary mb-2"><i class="mdi mdi-plus-circle mr-2"></i><?= lang('add_member') ?></a>
                    ...
                    <tbody>
                        <?php foreach ($members as $m) { ?>
                            <tr>
                                ...
                                <td><?= $m->phone ?></td>
                                <td> <span class="badge badge-success-lighten"><?= $m->g_name ?></span></td>
                                <td> <span class="badge badge-primary-lighten"><?= $m->role ?></span></td>
                                <td>
