                        ...
                        <?php foreach ($members as $m) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('Are you sure you want to delete')" data-fancy href="<?= base_url('memberexit/delete/' . $this->utility->mask($m->member_exit_id)) ?>" data-toggle="tooltip" title="<?= lang('delete') ?>" class="btn btn-danger btn-sm"><i class="mdi mdi-delete"></i> </a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
