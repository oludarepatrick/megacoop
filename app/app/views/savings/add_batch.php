        ...
        <div class="card">
            ...
            <div class="card-body bg-light m-3 rounded">
                ...
                <a id="hide_generate_savin_btn" data-toggle="tooltip" data-placement="bottom" title="Download"
                   class="btn btn-primary text-white mb-2" onclick="generate_savings_template()">
            ...
            <div class="card-body">
                ...
                <?= form_open_multipart('savings/add_batch', 'class="needs-validation" novalidate') ?>
                <div class="row">
