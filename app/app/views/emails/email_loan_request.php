            ...
            <div style="padding: 3%">
                <?php if ($status == "request") { ?>
                    <div style="text-align: left; ">
                        ...
                        <p style="margin: 0% 0% 4% 0%;">Your loan request has been received and its under processing, you will be notified
                            once the processing is completed. The loan schedule is as follows.</p>
                    </div>
                <?php } ?>
                <?php if ($status == "approved") { ?>
                    <div style="text-align: left; ">
                        <p style="font-size:14px">Hello <?= ucwords($name) ?> <br> MemberID: <?= $member_id ?></p>
                        <p style="margin: 0% 0% 4% 0%;">Your loan request has been approved for disbursement.</p>
                    </div>
                <?php } ?>
